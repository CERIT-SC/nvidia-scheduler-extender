...
```bash
cd /etc/kubernetes/
curl -O https://raw.githubusercontent.com/CERIT-SC/gpushare-scheduler-extender/master/config/scheduler-policy-config.json
cd /tmp/
curl -O https://raw.githubusercontent.com/CERIT-SC/gpushare-scheduler-extender/master/config/gpushare-schd-extender.yaml
...
```bash
wget https://raw.githubusercontent.com/CERIT-SC/gpushare-device-plugin/master/device-plugin-rbac.yaml
kubectl create -f device-plugin-rbac.yaml
wget https://raw.githubusercontent.com/CERIT-SC/gpushare-device-plugin/master/device-plugin-ds.yaml
